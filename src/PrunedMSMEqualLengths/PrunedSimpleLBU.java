...
import DifferentLengths.PrunedSLUUnequalGreedy;
import Heuristics.Greedy;

import java.util.Arrays;
import java.util.Objects;

public class PrunedSimpleLBU {
    final double c;
     ...
     */
    public PrunedSimpleLBU(double c, double[] X, double[] Y, String UB) {
        this.c = c;
        this.X = X;
        this.Y = Y;
        this.m = X.length;
    ...
    public static void main(String[] args) {
        ...
        PrunedSimpleLBU prunedSimpleLBU = new PrunedSimpleLBU(0.1,ts1, ts2, "g");
        double distPrunedWithBand = prunedSimpleLBU.msmDistPruned()[0];
        long end = System.nanoTime();
        System.out.println("equal: " + (end-start));

        long start2 = System.nanoTime();
        PrunedSLUUnequalGreedy prunedSLUUnequalGreedy = new PrunedSLUUnequalGreedy(0.1,ts1,ts2);
        prunedSLUUnequalGreedy.msmDistPruned();
        long end2 = System.nanoTime();

        System.out.println("unequal: " + (end2-start2));
