...
public class PrunedSLUBUnequalItakura {
    ...
    public static void main(String[] args) {
        ...
        DifferentLengths.PrunedSLUBUnequalItakura prunedSLUBUnequalItakura = new DifferentLengths.PrunedSLUBUnequalItakura(0.1, ts1, ts2);
        System.out.println(prunedSLUBUnequalItakura.msmDistPruned()[0]);
