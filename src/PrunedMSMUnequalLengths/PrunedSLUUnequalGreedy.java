  ...
  //      System.out.println("counter update: " + counterUpdate);
    ...
    public static void main(String[] args) {
       ...
       // double[] ts1 = new double[]{1, 5, 2, 5, 6, 5};
        ...
        PrunedSLUUnequalGreedy prunedSLUUnequalGreedy = new PrunedSLUUnequalGreedy(0.1, ts1, ts2);
        System.out.println(prunedSLUUnequalGreedy.msmDistPruned()[0]);
    }
}
