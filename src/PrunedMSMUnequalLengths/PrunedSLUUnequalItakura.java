package DifferentLengths;

import MsmDistArray.MsmOriginal;

import java.util.Arrays;

public class PrunedSLUUnequalItakura {
    ...
    // for unequal lengths
    public PrunedSLUUnequalItakura(double c, double[] X, double[] Y) {
        this.c = c;
        this.X = X;
        this.Y = Y;
        this.m = X.length;
